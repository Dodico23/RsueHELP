...
init python:
    ...
    if not persistent.achievements_dict:
        persistent.achievements_dict = {"znatok1": {"type": 0, # One time achievent
                                                             "title": "Знаток направлений.", # Also neame for steam
                                                             "text": "Ознакомиться со всеми направлениями КТиИБ", # description
                                                             "icon": "images/1.png" # 96x96 image
                                                             },
                                        "KT": {"type": 1, # One time achievent
                                                             "title": "Знаток направлений.", # Also neame for steam
                                                             "text": "Ознакомиться со всеми направлениями КТиИБ", # description
                                                             "icon": "images/1.png",
                                                             "cur_prog": 1,
                                                             "max_prog": 10 # 96x96 image
                                                             }         
